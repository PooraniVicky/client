...
//       try {
//         const quizData = {
//           title: values.title, // Assuming values.title is the title of the quiz
//           questions: [{
//             questionText: '', // Initialize with an empty string or values.questionText as needed
//             options: ['', '', '', ''], // Initialize with empty strings or values.options as needed
//             correctAnswer: 0 // Assuming the correct answer index, 0 for the first option
//           }],
//           courseId: courseId // Assuming courseId is defined and passed from your application
//         };
...
//                                       onClick={() =>
//                                         removeOption(
//                                           formik.values.questions[index].options.length - 1
//                                         )
//                                       }
//                                       className="mt-2 ms-2"
//                                     >
